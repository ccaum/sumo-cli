...
//NOTE: This file is taken from the the sumologic-go-sdk project
//It's necessary because the sumologic-go-sdk doesn't yet support
//importing folder content. When it does, the CLI tool should use
